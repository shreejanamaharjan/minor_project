...
<section class="speciality" id="speciality">
    ...
    <div class="box-container">
        <div class="box">
            <img class="image" src="momo.jpg" alt="">
        ...
        <div class="box">
            <img class="image" src="chicken chowmein-removebg-preview.jpg" alt="">
            <div class="content">
                <h3>Chowmein</h3>
                <h4>Ingredients</h4>
        ...
        <div class="box">
            <img class="image" src="sekuwa.jpg" alt="">
            <div class="content">
                <h3>Sekuwa</h3>
                <h4>Ingredients</h4>
        ...
        <div class="box">
            <img class="image" src="baraa.jpg" alt="">
            <div class="content">
        ...
        <div class="box">
            <img class="image" src="thukpa.jpg" alt="">
            <div class="content">
                <h3>Thukpa</h3>
                <h4>Ingredients</h4>
        ...
        <div class="box">
            <img class="image" src="khana-removebg-preview.jpg" alt="">
            <div class="content">
                <h3>Khana set</h3>
                <h4>Ingredients</h4>
